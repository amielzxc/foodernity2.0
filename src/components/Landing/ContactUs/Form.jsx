  ...
  return (
    ...
    >
      ...
      <Grid item xs={11} md={5}>
        ...
        >
          Here, we value everyone who share the same goals with us — to reduce
          food waste, help achieve zero hunger, and strenghten communities. As
          long as we help one another in achieving these goals through our
          shared commitments, we can transform our world into a better place.
        </Typography>
        <Typography
          variant="h5"
          style={{
      ...
      <Grid item xs={9} sm={6} md={4}>
        <form>
          ...
          <TextField variant="standard" fullWidth placeholder="Foodernity" />
          <Typography
            variant="h6"
            style={{
              textAlign: sm ? "center" : "left",
          ...
          <TextField variant="standard" fullWidth placeholder="09591248192" />
          <Typography
            variant="h6"
            style={{
              textAlign: sm ? "center" : "left",
