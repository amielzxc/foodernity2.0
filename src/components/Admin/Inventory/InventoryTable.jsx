...
const columns = [
  ...
  },
  {
    ...
    width: 200,
    renderCell: (params) => {
      return <StyledChip label={params.row.productName} />;
    },
  },
  {
    field: "received",
    ...
    type: "number",
    renderCell: (params) => {
      return <Typography>{params.row.received} pcs</Typography>;
    },
  },
  {
    field: "donated",
    ...
    type: "number",
    renderCell: (params) => {
      return <Typography>{params.row.donated} pcs</Typography>;
    },
  },
  {
    field: "balance",
    ...
    renderCell: (params) => {
      return (
        <Typography
          style={{ color: params.row.balance < 30 ? "red" : "green" }}
        >
          {params.row.balance} pcs left
        </Typography>
      );
    },
  },
